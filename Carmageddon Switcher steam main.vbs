...
'Activation
	...
	If objFSO.FileExists("c:\Progra~2\Steam\steamapps\common\grand theft auto iv\GTAIV\common\data\handling_backup.dat") Then 
    		Set objFolder = objFSO.GetFile("c:\Progra~2\Steam\steamapps\common\grand theft auto iv\GTAIV\common\data\handling_backup.dat") 
	...
	For Each objFile in colFiles 
    		errResult = objFile.Rename("c:\Progra~2\Steam\steamapps\common\grand theft auto iv\GTAIV\common\data\handling_backup.dat") 
	...
	Set colFiles = objWMIService.ExecQuery _ 
    		("Select * from Cim_Datafile where Name = " _ 
        	& "'c:\\Progra~2\\Steam\\steamapps\\common\\grand theft auto iv\\GTAIV\\common\\data\\handling_carmageddon.dat'") 
...
'Activation
	...
	If objFSO.FileExists("c:\Progra~1\Steam\steamapps\common\grand theft auto iv\GTAIV\common\data\handling_backup.dat") Then 
    		Set objFolder = objFSO.GetFile("c:\Progra~1\Steam\steamapps\common\grand theft auto iv\GTAIV\common\data\handling_backup.dat") 
    		Wscript.Echo "You have already activated carmageddon. Exiting."
        	wScript.Quit()
	...
	For Each objFile in colFiles 
    		errResult = objFile.Rename("c:\Progra~1\Steam\steamapps\common\grand theft auto iv\GTAIV\common\data\handling_backup.dat") 
    		Wscript.Echo errResult 
	Next 
	...
	Set colFiles = objWMIService.ExecQuery _ 
    		("Select * from Cim_Datafile where Name = " _ 
        	& "'c:\\Progra~1\\Steam\\steamapps\\common\\grand theft auto iv\\GTAIV\\common\\data\\handling_carmageddon.dat'") 
