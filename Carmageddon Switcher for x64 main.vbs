...
' OutputFile: C:\Users\Victor\Desktop\Carmageddon\Carmageddon Switcher x64.exe
...
Dim sContinue, objFolder, objFSO, strComputer, objWMIService, colfiles, objFile, errResult, colProcesslist, objProcess
 
	Set objFSO = CreateObject("Scripting.FileSystemObject")
	If objFSO.FolderExists("C:\Program Files (x86)\") Then
'----------------------------------------------------------------
'64-bit system. Starting script.
...
'-----------------------------------------------------------------
	Else
    		MsgBox "This is not a 64-bit system!"
		wScript.Quit()
	End If
